...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [MatCardModule, MatButtonModule, CommonModule, RouterOutlet, HeaderComponent, ProjectComponent, CvComponent, AboutMeComponent, FooterComponentComponent],
